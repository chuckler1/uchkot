        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <p className="font-neucha text-2xl">Учёный кот</p>
            ...
            <p className="text-[var(--secondary)] leading-relaxed mb-6">
              Мы помогаем детям открывать мир знаний через игру, творчество и обучение. Создаём комфортную и безопасную среду для развития малышей от 3 до 7 лет.
            </p>
          ...
          <div className="bg-white/50 rounded-2xl p-6 shadow-sm">
            <h3 className="font-semibold text-lg text-[var(--foreground)] mb-6">
              Свяжитесь с нами
            </h3>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <div className="bg-[var(--foreground)]/10 rounded-lg p-2 flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--secondary)]">
                    г. Йошкар-Ола, ул. Петрова, д. 2а, ТЦ "Глобус", каб. 224
                  </p>
                </div>
              </div>  
              <div className="flex items-start gap-3">
                <div className="bg-[var(--foreground)]/10 rounded-lg p-2 flex-shrink-0">
                  <Phone size={20} className="text-[var(--foreground)]" />
                </div>
                <div>
                  <p className="font-medium text-[var(--foreground)] mb-1">
                    Телефон
              ...
              <div className="flex items-start gap-3">
                <div className="bg-[var(--foreground)]/10 rounded-lg p-2 flex-shrink-0">
                  <Mail size={20} className="text-[var(--foreground)]" />
                </div>
                <div>
                  <p className="font-medium text-[var(--foreground)] mb-1">
                    Email
